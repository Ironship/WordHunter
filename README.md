...
- **Linux - Nixpkgs (under review):**
  [submission #543250](https://github.com/NixOS/nixpkgs/pull/543250) is waiting
  for maintainer review. Word Hunter is not yet available from the central
  `nixpkgs` repository.
