...
- **Prerelease:** [1.0.9-rc.6](https://github.com/Ironship/WordHunter/releases/tag/WordHunter1.0.9-rc.6) — recovery-safe JSON backup imports when a local text record or interrupted save journal is unreadable. See [release notes](docs/releases/1.0.9-rc.6.md). **Prerelease artifacts are for testing only and do not update stable installs.**
