...
candidates and replaces the preliminary course-book content from RC9 with
finished graded readers.
...
- **Fixed:** Built-in Library records and SVG accessibility metadata now use
  the actual reader titles instead of notice headings.
