...
describe("repository validation wiring", () => {
  ...
  const TS_CREATED_IDS = new Set([
    ...
    "edit-book-text-counter", // book-actions/edit-modal.ts (renderEditBookDialog)
    "edit-book-fmt-bold", // book-actions/edit-modal.ts (renderEditBookDialog)
    "edit-book-fmt-italic", // book-actions/edit-modal.ts (renderEditBookDialog)
