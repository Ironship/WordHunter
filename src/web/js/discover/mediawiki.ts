 ...
 * NOTE: Wikisource was intentionally removed (owner decision, rc.4 review):
 * scanned source texts produced short, chaotic stubs. Only Wikipedia and
...
export type MediaWikiSource = "wikipedia" | "wikinews";
